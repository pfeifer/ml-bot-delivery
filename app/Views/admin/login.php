    ...
    <div class="container login-container bg-white p-4 p-md-5 rounded shadow">
        ...
        <?= form_open(route_to('login')) ?>
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" id="email" class="form-control <?= (isset(validation_errors()['email'])) ? 'is-invalid' : '' ?>" value="<?= old('email') ?>" required>
            ...
            <div class="mb-3">
                ...
                <input type="password" name="password" id="password" class="form-control <?= (isset(validation_errors()['password'])) ? 'is-invalid' : '' ?>" required>
                 <?php if (isset(validation_errors()['password'])): ?>
                     <div class="invalid-feedback"><?= validation_errors()['password'] ?></div>
                <?php endif; ?>
            </div>
            <div class="d-grid">
                <button type="submit" class="btn btn-primary" style="background-color: #DC4814; border-color: #DC4814;">Entrar</button>
            </div>
        <?= form_close() ?>
    </div>
